...
import com.realmcloud.admin.base.TreeEntity;
import com.realmcloud.admin.dao.MenuDao;
...
import com.realmcloud.admin.service.MenuService;
import com.realmcloud.admin.util.MyCompare;
...
//    @Cacheable(value = "allMenus", key = "'user_menu_'+T(String).valueOf(#id)", unless = "#result == null or #result.size() == 0")
    @Override
    public List<ShowMenu> getShowMenuByUser(Long id, Long parentId) {
