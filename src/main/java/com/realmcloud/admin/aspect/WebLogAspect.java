package com.realmcloud.admin.aspect;

import com.alibaba.fastjson.JSONObject;
import com.realmcloud.admin.base.MySysUser;
import com.realmcloud.admin.entity.Log;
import com.realmcloud.admin.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.realmcloud.admin.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.realmcloud.admin.annotation.SysLog mylog = method.getAnnotation(com.realmcloud.admin.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
