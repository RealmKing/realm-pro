package com.realmcloud.admin.controller.projixie;
...
import com.realmcloud.admin.entity.BlogArticle;
import com.realmcloud.admin.entity.BlogChannel;
import com.realmcloud.admin.entity.BlogComment;
import com.realmcloud.admin.exception.MyException;
import com.realmcloud.admin.lucene.LuceneSearch;
import com.realmcloud.admin.util.Constants;
import com.realmcloud.admin.util.RestResponse;
import com.realmcloud.admin.util.ToolUtil;
...
/**
 * Created by realm on 2018/1/21.
 * todo:
 */
@RequestMapping("projixie")
@Controller
public class IndexPageController extends BaseController {
    ...
    public String redictProducts() {
        return "/projixie/products";
    }
    ...
    public String redictContact() {
        return "/projixie/contact";
    }
    ...
    public String redictNews() {
        return "/projixie/news";
    }
