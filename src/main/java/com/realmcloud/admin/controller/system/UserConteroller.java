package com.realmcloud.admin.controller.system;
...
/**
 * Created by realm  on 2017/11/21.
 */
@Controller
...
public class UserConteroller extends BaseController {
    ...
    @ResponseBody
    public List<ShowMenu> getUserMenu(@RequestParam(value = "parentId", required = false) Long parentId) {
        Long userId = MySysUser.id();
        List<ShowMenu> list = menuService.getShowMenuByUser(userId, parentId);
        return list;
    }
